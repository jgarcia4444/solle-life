        ...
        <div id="buy" className="">
            ...
            <div className="mt-4 bg-white p-4 rounded shadow flex flex-row flex-wrap">
                <div className="flex lg:flex-row flex-col justify-between lg:items-center items-start w-full mb-4 lg:mb-0">
                    <h3 className="text-lime-300 text-left text-3xl lg:text-4xl font-bold">Become a Solle Member</h3>
                ...
                <p className="text-white mt-4 font-bold text-lg text-left bg-lime-300 p-2 rounded">To buy tap the button at the top right of this section and scroll to Solle Member and buy the best products!</p>
            </div>
        </div>
    )
};
